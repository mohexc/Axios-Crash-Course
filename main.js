...
function updateTodo() {
  ...
  axios
    ...
    // .path('https://jsonplaceholder.typicode.com/todos/1', { title: 'Updated Todo', completed: true })
    .then(res => showOutput(res))
    .catch(err => console.error(err))
}
...
document.getElementById('transform').addEventListener('click', tranformResponse)
